...
| `CALL_DEFLECT_SPOKEN_CLINIC_NAME` | `My MD Telehealth` | How the name is **pronounced**, which differs from how it's spelled — TTS reads "MyMD" as one mangled word. Speech only; the SMS keeps the real spelling. Falls back to the name on record. |
