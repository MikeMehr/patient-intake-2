...
When you set "requiresLocationMarking": true, also set "locationBodyParts" to a NON-EMPTY array of body-part keys matching the diagrams to display. Valid keys ONLY: knee, lower_leg, ankle, foot, hip, shoulder, elbow, hand, wrist, neck, head, back, upper_back, lower_back, chest, abdomen. Do NOT use keys like "bone", "skeleton", "joint", or any other key not in this list.
