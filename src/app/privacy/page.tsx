    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <Section title="11. Data Retention">
          <P><strong>Patient session PHI</strong> is automatically and permanently deleted at the end of the configured retention window. <strong>Finalized clinical records</strong> (SOAP notes exported to EMR) are retained for a default of <strong>7 years</strong> from the date of finalization. <strong>Draft records</strong> (unfinished SOAP notes, session data, labs, and prescriptions) are retained for a default of <strong>3 years</strong> from creation. Healthcare organizations may configure longer windows through their account settings. On-demand deletion is available at any time through the platform dashboard.</P>
