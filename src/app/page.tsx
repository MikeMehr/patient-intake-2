...
const UI_JSON_KEY_MAP: Record<string, string> = {
  ...
  mute: "buttons.mute",
  muted: "buttons.muted",
  muteTitle: "buttons.mute_title",
  unmuteTitle: "buttons.unmute_title",
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const strings: Record<string, string> = {
      ...
      sttReviewTitle: "Voice input check",
      sttReviewBody: "Voice recognition is not always perfect. The text above may contain errors — please check it carefully before submitting.",
