...
- "medications": ONLY prescriptions the physician EXPLICITLY dictated as an order — drug name + dose + frequency at minimum, plus quantity/repeats when stated (e.g. "Naproxen 500 mg PO BID PRN pain, #40"). One per line. NEVER include medications that were merely mentioned, reviewed, continued without a new order, or implied by the clinical picture — do not invent prescriptions. Empty string "" if no prescription was dictated.
  Named-regimen exception: when the physician explicitly ORDERS "H. pylori quadruple therapy" (also "bismuth quadruple therapy" or "PBMT") by name, expand it into the clinic's standard regimen, one line per drug: "Esomeprazole (Nexium) 40 mg PO BID x 14 days", "Bismuth subsalicylate 262 mg 2 tabs PO QID x 14 days", "Tetracycline 250 mg 2 tabs PO QID x 14 days", "Metronidazole 500 mg PO TID x 14 days". Any component the physician dictated differently (drug, dose, duration) overrides the standard for that line; merely discussing H. pylori or its treatment options does NOT trigger the expansion.
