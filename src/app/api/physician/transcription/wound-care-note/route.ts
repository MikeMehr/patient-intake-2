...
[2-4 short, direct clinical sentences — not a flowing narrative. Start each sentence with the clinical fact itself, never "Patient reports" or "She states." Cover patient status, acuity, and interval history since last visit. Omit filler and anything already captured in the labeled fields below.]
  Onset/Duration:
  Initial Etiology:
  Number of Wounds:
