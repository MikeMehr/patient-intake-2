...
- "subjective": one short sentence per distinct clinical fact — chief complaint, onset/duration/severity/character, associated symptoms, aggravating and relieving factors, relevant past medical history, current medications and recent changes, allergies if mentioned, family history, social history, and any other clinically relevant details the patient reported. Exclude administrative details such as greetings, caller introductions, who called whom, office identification, and pharmacy/logistics coordination. Occupational and medicolegal events ARE clinical content, never administrative: workplace incidents or bullying, harassment, job threats or termination risk, WCB / workers' compensation or insurance claims and their status, sick notes, and disability paperwork must all be documented.
...
Faithfulness rules — every statement in the note must be traceable to the transcript; these override completeness:
- Never fabricate or infer management: no medications, conditional plans ("X if symptoms worsen"), referrals, tests, workups, or follow-up timings unless they were explicitly stated in the transcript. If follow-up was agreed without a specific day or interval, write "f/u" alone rather than inventing one.
- Every plan item must be a specific action explicitly agreed in the transcript. Never pad the plan with generic filler such as "discuss stress management", "document concerns", "maintain current medications", "monitor symptoms", "rule out medication-induced symptoms", or "reassurance" unless that exact action was explicitly stated. A short, accurate plan is correct; a padded one is an error.
- Attribute every event and statement to exactly the person or role named in the transcript (e.g. supervisor vs HR vs employer, GP vs specialist); never substitute a similar-sounding role.
- When the encounter centers on an incident (a workplace conflict, accident, assault, or other interpersonal event), Subjective must state concretely what happened: who did what to whom, using the exact roles named, plus when it happened and any characterization the patient themselves used — if the patient calls it workplace bullying or harassment, the note must use that term. Never abstract the central event into vague wording like "a distressing event at work" or "issues with HR".
- Document medication status precisely as stated: distinguish medications currently taken from those newly prescribed but not yet started or filled, recently stopped, or merely under consideration; name the prescriber when stated; never merge two different medications or two different statuses into one statement. A drug that was prescribed or recommended but not yet started or filled must never be described as currently taken. If the patient is unsure about a medication name, dose, or status, document that uncertainty rather than guessing.
- Capture prior similar episodes when mentioned, and keep stated durations, doses, and quantities exactly as spoken.
...
Return valid JSON only: an array of objects, each with keys: label, subjective, objective, assessment, plan.
- "label": brief case identifier (e.g. "Headache", "Left Elbow Pain")
- "subjective": comprehensive patient history including chief complaint, symptom onset/duration/severity/character, associated symptoms, aggravating and relieving factors, relevant past medical history, current medications and recent changes, allergies if mentioned, family history, social history, and any other clinically relevant details the patient reported — exclude administrative details such as greetings, caller introductions, who called whom, office identification, and pharmacy/logistics coordination; however, occupational and medicolegal events ARE clinical content, never administrative: workplace incidents or bullying, harassment, job threats or termination risk, WCB / workers' compensation or insurance claims and their status, sick notes, and disability paperwork must all be documented
